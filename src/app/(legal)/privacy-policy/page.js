    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg dark:prose-invert mx-auto">
          ...
          <p>To create an account, you must provide your email address. To receive payments as a creator, you will be required to provide further Personal Information (such as your legal name, address, and government ID) directly to our payment processor, Stripe. We do not receive or store this sensitive financial and identification information on our servers.</p>
          
          <h3>Information Collected via Technology</h3>
          <p>When you use our Service, we automatically track information provided by your browser or device, such as your IP address, device type, and access times. We use cookies (small text files stored on your computer) to collect this Non-Personal Information, which helps us operate the Site and remember your preferences.</p>
          ...
          <ul>
            ...
            <li>Communicate with you, such as responding to inquiries or sending important service-related notices.</li>
            <li>Provide technical support.</li>
            <li>Enforce our Terms of Use.</li>
          </ul>
          <p>We may share your email address with trusted third-party vendors who perform services for us (such as our email delivery provider, Resend), but only at our direction and in accordance with this policy. We may also disclose Personal Information if required by law or in the good-faith belief that such action is necessary to comply with a legal process.</p>
