...
export default function ProfileForm({ initialData: profile, serverError }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-8 md:p-16 rounded-xl shadow-lg max-w-4xl mx-auto w-full"> {/* Adjusted max-width slightly for better spacing */}
      ...
      {success && <p className="text-green-600 dark:text-green-300 mb-4 p-3 bg-green-100 dark:bg-green-900/30 rounded text-sm text-center">{success}</p>}
       ...
       <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
        {/* Banner Image Upload Section - Refactored for stability */}
        <div className="space-y-2">
          ...
          {/* Single container with fixed aspect ratio */}
          ...
          <input 
            ...
            className="hidden" 
            id="bannerUploadButton" // Link the label to the input
