      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
        <div>
          ...
          <div className="mt-2 w-full max-w-3xl mx-auto aspect-[3/1] rounded-lg relative bg-gray-200 dark:bg-gray-700/50 border border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center overflow-hidden">
            {currentProfile?.bannerImageUrl ? <Image src={currentProfile.bannerImageUrl} alt="Banner Preview" layout="fill" className="object-cover" key={currentProfile.bannerImageUrl} /> : <span className="text-gray-500 dark:text-gray-400">No banner</span>}
          </div>
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="w-32 h-32 rounded-full overflow-hidden relative bg-gray-200 border-2 border-gray-300 dark:border-gray-700 shadow-sm">
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-4">
              ...
              <input 
                ...
                className="w-28 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-black dark:text-white bg-white dark:bg-gray-700" 
              />
            </div>
            {showColorPicker && (
