    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6 max-w-2xl bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
      ...
      <div className="flex flex-col items-center">
          ...
          <div className="relative w-32 h-32">
              ...
              <label htmlFor="avatarFile" className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40 text-white text-xs font-semibold rounded-full opacity-0 hover:opacity-100 transition-opacity cursor-pointer">Change</label>
